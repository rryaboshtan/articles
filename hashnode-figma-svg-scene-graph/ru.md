...
**Плагины** (SVGO в Figma, пайплайны иконок, «flatten to outline») бывают лучше и хуже нативного экспорта. Плагин, который перед сериализацией обводит stroke и делает union булевых, сэкономит неделю. Плагин, который гоняет дефолтный пресет SVGO с `removeViewBox`, сделает баннер 300×150. Смотри выход плагина так же, как нативный экспорт. Чекбоксу «optimize» не верь.
...
Пересчитай по чернилам (с запасом) или выгрузи Frame иконки. Тесная коробка и CSS — [viewBox vs width/height vs CSS](https://roman-riaboshtan.hashnode.dev/svg-viewbox-vs-width-height-css). Но не раньше, чем контракт перестанет описывать рабочий стол.
...
Редактор на [getsvgeditor.com](https://getsvgeditor.com) как раз под этот цикл: слева исходник, справа превью. Ты ещё не конвертируешь. Ты спрашиваешь, описывает ли документ всё ещё страницу.
